							...
							<td class="text-center">
								<div class="btn-group">
									<a class="btn-success btn btn-xs"
									   href="/categories/edit/${c.id}"><spring:message code="common.button.update" text="default text"/></a>
									<c:if test="${count == 0}">
									<a type="button" data-toggle="modal" data-target="#deleteButton"
									   class="btn-danger btn btn-xs"
									   onclick="setUrl('/categories/delete/${c.id}')"><spring:message code="common.button.delete" text="default text"/></a>
									</c:if>
								</div>
							</td>
						</tr>
