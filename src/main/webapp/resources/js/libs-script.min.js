...
!function (a, b) {
            ...
            init: function () {
                ...
                g ? (b.style.msTouchAction = "none", b._gesture = new MSGesture, b._gesture.target = b, b.addEventListener("MSPointerDown", a, !1), b._slider = d, b.addEventListener("MSGestureChange", c, !1), b.addEventListener("MSGestureEnd", e, !1)) : (q = function (a) {
                        ...
                        if (b.removeEventListener("touchmove", r, !1), d.animatingTo === d.currentSlide && !t && null !== o) {
                            var a = l ? -o : o, c = d.getTarget(a > 0 ? "next" : "prev");
            ...
            if (n) d.slides.css({
                ...
                position: "relative"
                    ...
                    zIndex: 2
                        ...
                        display: "block",
                        zIndex: 1
                    }).eq(d.currentSlide).css({zIndex: 2}).css({opacity: 1}) : d.slides.css({
                        opacity: 0,
                        display: "block",
                        zIndex: 1
    ...
    a.event.special.inview = {
        add: function (b) {
            d[b.guid + "-" + this[h]] = {data: b, $element: a(this)}
        }, remove: function (a) {
            try {
        ...
        if (a.each(d, function (a, b) {
            ...
            var k;
            if (!(k = b)) {
                var l = {height: f.innerHeight, width: f.innerWidth};
    ...
    var b = {
        ...
        for (var b = c.scrollTop(), g = d.height(), h = g - f, i = b > h ? h - b : 0, j = 0; j < e.length; j++) {
            ...
            if (m >= b) null !== k.currentTop && (k.stickyElement.css("position", "").css("top", ""), k.stickyElement.trigger("sticky-end", [k]).parent().removeClass(k.className), k.currentTop = null); else {
        ...
        init: function (c) {
            var d = a.extend({}, b, c);
            return this.each(function () {
                var c = a(this), f = c.attr("id"), g = (f ? f + "-" + b.wrapperClassName : b.wrapperClassName, a("<div></div>").attr("id", f + "-sticky-wrapper").addClass(d.wrapperClassName));
                c.wrapAll(g), d.center && c.parent().css({
                    width: c.outerWidth(),
                    marginLeft: "auto",
                    marginRight: "auto"
                }), "right" == c.css("float") && c.css({float: "none"}).parent().css({float: "right"});
                var h = c.parent();
                h.css("border", "none"), e.push({
        ...
        }, update: g, unstick: function () {
            return this.each(function () {
                for (var b = a(this), c = -1, d = 0; d < e.length; d++)e[d].stickyElement.get(0) == b.get(0) && (c = d);
    ...
    a.fn.theiaStickySidebar = function (b) {
        ...
        b = a.extend(c, b), b.additionalMarginTop = parseInt(b.additionalMarginTop) || 0, b.additionalMarginBottom = parseInt(b.additionalMarginBottom) || 0,
            a("head").append(a('<style>.theiaStickySidebar:after {content: ""; display: table; clear: both;}</style>')), this.each(function () {
            function c() {
            ...
            var f = e.stickySidebar.offset().top, g = e.stickySidebar.outerHeight();
            e.stickySidebar.css("padding-top", 1), e.stickySidebar.css("padding-bottom", 1), f -= e.stickySidebar.offset().top, g = e.stickySidebar.outerHeight() - g - f, 0 == f ? (e.stickySidebar.css("padding-top", 0), e.stickySidebarPaddingTop = 0) : e.stickySidebarPaddingTop = 1, 0 == g ? (e.stickySidebar.css("padding-bottom", 0), e.stickySidebarPaddingBottom = 0) : e.stickySidebarPaddingBottom = 1, e.previousScrollTop = null, e.fixedScrollTop = 0, c(), e.onScroll = function (e) {
                if (e.stickySidebar.is(":visible")) {
                    ...
                    var f = a(document).scrollTop(), g = "static";
                    if (f >= e.container.offset().top + (e.paddingTop + e.marginTop - e.options.additionalMarginTop)) {
                        var h, i = e.paddingTop + e.marginTop + b.additionalMarginTop, j = e.paddingBottom + e.marginBottom + b.additionalMarginBottom, k = e.container.offset().top, l = e.container.offset().top + d(e.container), m = 0 + b.additionalMarginTop, n = e.stickySidebar.outerHeight() + i + j < a(window).height();
                        h = n ? m + e.stickySidebar.outerHeight() : a(window).height() - e.marginBottom - e.paddingBottom - b.additionalMarginBottom;
                        var o = k - f + e.paddingTop + e.marginTop, p = l - f - e.paddingBottom - e.marginBottom, q = e.stickySidebar.offset().top - f, r = e.previousScrollTop - f;
                    ...
                    "static" != g && 1 == e.options.updateSidebarHeight && e.sidebar.css({"min-height": e.stickySidebar.outerHeight() + e.stickySidebar.offset().top - e.sidebar.offset().top + e.paddingBottom}), e.previousScrollTop = f
                }
...
}(jQuery, window, document), "object" != typeof ytp && (ytp = {}), function (jQuery, ytp) {
    ...
    jQuery.fn.CSSAnimate = function (a, b, c, d, e) {
        return this.each(function () {
            var f = jQuery(this);
            if (0 !== f.length && a) {
                if ("function" == typeof b && (e = b, b = jQuery.fx.speeds._default), "function" == typeof c && (e = c, c = 0), "function" == typeof d && (e = d, d = "cubic-bezier(0.65,0.03,0.36,0.72)"), "string" == typeof b)for (var g in jQuery.fx.speeds) {
                    if (b == g) {
        ...
        buildPlayer: function (options) {
            return this.each(function () {
                ...
                var playerID = "mbYTP_" + YTPlayer.id, videoID = this.opt.videoURL ? this.opt.videoURL.getVideoID() : !!$YTPlayer.attr("href") && $YTPlayer.attr("href").getVideoID();
                                    ...
                                    events: {
                                        onReady: function (a) {
                                            ...
                                            if ("function" == typeof a.target.getPlayerState) {
                                                ...
                                                var c = (jQuery(YTPlayer.playerEl), jQuery("#controlBar_" + YTPlayer.id)), d = YTPlayer.opt;
                                                if (0 == b) {
                                                    if (YTPlayer.state == b)return;
                                                    YTPlayer.state = b, YTPlayer.player.pauseVideo();
                                                    var e = YTPlayer.opt.startAt ? YTPlayer.opt.startAt : 1;
                                                    d.loop ? (YTPlayer.wrapper.css({opacity: 0}), $YTPlayer.playYTP(), YTPlayer.player.seekTo(e, !0)) : YTPlayer.isBackground || (YTPlayer.player.seekTo(e, !0), $YTPlayer.playYTP(), setTimeout(function () {
                                                            $YTPlayer.pauseYTP()
                                                        }, 10)), !d.loop && YTPlayer.isBackground ? YTPlayer.wrapper.CSSAnimate({opacity: 0}, 2e3) : d.loop && (YTPlayer.wrapper.css({opacity: 0}), YTPlayer.loop++), c.find(".mb_YTVPPlaypause").html(jQuery.mbYTPlayer.controls.play), jQuery(YTPlayer).trigger("YTPEnd")
                                                }
                                                if (3 == b) {
                                                    if (YTPlayer.state == b)return;
                                                ...
                                                if (-1 == b) {
                                                    if (YTPlayer.state == b)return;
                                                    YTPlayer.state = b, YTPlayer.wrapper.css({opacity: 0}), jQuery(YTPlayer).trigger("YTPUnstarted")
                                                }
                                                if (1 == b) {
                                                    if (YTPlayer.state == b)return;
                                                    YTPlayer.state = b, YTPlayer.player.setPlaybackQuality(YTPlayer.opt.quality), YTPlayer.opt.mute && ($YTPlayer.muteYTPVolume(), YTPlayer.opt.mute = !1), YTPlayer.opt.autoPlay && 0 == YTPlayer.loop ? YTPlayer.wrapper.CSSAnimate({opacity: YTPlayer.isAlone ? 1 : YTPlayer.opt.opacity}, 2e3) : YTPlayer.isBackground ? setTimeout(function () {
        ...
        playPrev: function () {
            var a = this.get(0);
            a.videoCounter--, a.videoCounter <= 0 && (a.videoCounter = a.videoLength), jQuery(a.playerEl).css({opacity: 0}), jQuery(a).changeMovie(a.videos[a.videoCounter])
        },
        changeMovie: function (a) {
            var b = this.get(0), c = b.opt;
            ...
            if (jQuery(b).getPlayer().cueVideoByUrl(encodeURI(jQuery.mbYTPlayer.locationProtocol + "//www.youtube.com/v/" + b.videoID), 5, b.opt.quality), setTimeout(function () {
                    jQuery(b).playYTP(), jQuery(b).one("YTPStart", function () {
                        jQuery(b.playerEl).CSSAnimate({opacity: 1}, 2e3)
                    })
        ...
        fullscreen: function (a) {
            ...
            var e = this.get(0), f = jQuery("#controlBar_" + e.id), g = f.find(".mb_OnlyYT"), h = jQuery(e.wrapper);
            if (a) {
            ...
            e.isAlone ? (a ? d() : h.CSSAnimate({opacity: e.opt.opacity}, 500), jQuery(e).trigger("YTPFullScreenEnd"), h.css({zIndex: -1}), g.html(jQuery.mbYTPlayer.controls.onlyYT), e.isAlone = !1) : (1 != e.player.getPlayerState() && 2 != e.player.getPlayerState() && jQuery(e).playYTP(), a ? (e.wrapper.append(f), jQuery(e).addClass("fullscreen"), c(h.get(0))) : h.css({zIndex: 1e4}).CSSAnimate({opacity: 1}, 1e3, 0), jQuery(e).trigger("YTPFullScreenStart"), g.html(jQuery.mbYTPlayer.controls.showSite), e.isAlone = !0)
        },
        playYTP: function () {
            var a = this.get(0), b = jQuery("#controlBar_" + a.id), c = b.find(".mb_YTVPPlaypause");
            c.html(jQuery.mbYTPlayer.controls.pause), a.player.playVideo(), a.wrapper.CSSAnimate({opacity: a.opt.opacity}, 2e3), jQuery(a).on("YTPStart", function () {
        ...
        pauseYTP: function () {
            var a = this.get(0), b = (a.opt, jQuery("#controlBar_" + a.id)), c = b.find(".mb_YTVPPlaypause");
        ...
        muteYTPVolume: function () {
            ...
            var b = jQuery("#controlBar_" + a.id), c = b.find(".mb_YTVPMuteUnmute");
        ...
        manageYTPProgress: function () {
            var a = this.get(0), b = jQuery("#controlBar_" + a.id), c = b.find(".mb_YTVPProgress"), d = b.find(".mb_YTVPLoaded"), e = b.find(".mb_YTVTime"), f = c.outerWidth(), g = Math.floor(a.player.getCurrentTime()), h = Math.floor(a.player.getDuration()), i = g * f / h, j = 0, k = 100 * a.player.getVideoLoadedFraction();
        ...
        buildYTPControls: function () {
            ...
            if (!jQuery("#controlBar_" + a.id).length) {
                ...
                }).hide(), d = jQuery("<div/>").addClass("buttonBar"), e = jQuery("<span>" + jQuery.mbYTPlayer.controls.play + "</span>").addClass("mb_YTVPPlaypause ytpicon").click(function () {
                ...
                }), g = jQuery("<span/>").addClass("mb_YTVPTime"), h = b.videoURL;
                ...
                var i = jQuery("<span/>").html(jQuery.mbYTPlayer.controls.ytLogo).addClass("mb_YTVPUrl ytpicon").attr("title", "view on YouTube").on("click", function () {
                    ...
                    m.css({width: b.clientX - m.offset().left}), a.timeW = b.clientX - m.offset().left, c.find(".mb_YTVPLoaded").css({width: 0});
                    var d = Math.floor(a.player.getDuration());
                    a.goto = m.outerWidth() * d / k.outerWidth(), a.player.seekTo(parseFloat(a.goto), !0), c.find(".mb_YTVPLoaded").css({width: 0})
                }), l = jQuery("<div/>").addClass("mb_YTVPLoaded").css("position", "absolute"), m = jQuery("<div/>").addClass("mb_YTVTime").css("position", "absolute");
        ...
        checkForState: function (a) {
            var b = jQuery("#controlBar_" + a.id), c = a.opt, d = a.opt.startAt ? a.opt.startAt : 1;
            a.getState = setInterval(function () {
                var e = jQuery(a).manageYTPProgress();
                b.find(".mb_YTVPTime").html(jQuery.mbYTPlayer.formatTime(e.currentTime) + " / " + jQuery.mbYTPlayer.formatTime(e.totalTime)), parseFloat(a.player.getDuration() - 3) < a.player.getCurrentTime() && 1 == a.player.getPlayerState() && !a.isPlayList && (c.loop ? a.player.seekTo(d) : (a.player.pauseVideo(), a.wrapper.CSSAnimate({opacity: 0}, 2e3, function () {
        ...
        var a = this.get(0), b = a.opt, c = jQuery(a.playerEl), d = {}, e = a.isBackground ? jQuery(window) : b.containment;
    ...
    function nv_enableNavi(a, b, c) {
        if (!a.circular && !a.infinite) {
            var d = ("removeClass" == b || "addClass" == b) && b, e = cf_c("disabled", c);
    ...
    function bt_pauseOnHoverConfig(a) {
        if (is_string(a))var b = a.indexOf("immediate") > -1, c = a.indexOf("resume") > -1; else var b = c = !1;
        return [b, c]
    }
    ...
    $.fn.carouFredSel || ($.fn.caroufredsel = $.fn.carouFredSel = function (options, configs) {
        ...
        FN._init = function (a, b, c) {
            ...
            if (is_true(opts.cookie) && (opts.cookie = "caroufredsel_cookie_" + conf.serialNumber), opts.maxDimension = ms_getMaxDimension(opts, e), opts.items = in_complementItems(opts.items, opts, d, c), opts[opts.d.width] = in_complementPrimarySize(opts[opts.d.width], opts, d), opts[opts.d.height] = in_complementSecondarySize(opts[opts.d.height], opts, d), opts.responsive && (is_percentage(opts[opts.d.width]) || (opts[opts.d.width] = "100%")), is_percentage(opts[opts.d.width]) && (crsl.upDateOnWindowResize = !0, crsl.primarySizePercentage = opts[opts.d.width], opts[opts.d.width] = ms_getPercentage(e, crsl.primarySizePercentage), opts.items.visible || (opts.items.visibleConf.variable = !0)), opts.responsive ? (opts.usePadding = !1, opts.padding = [0, 0, 0, 0], opts.align = !1, opts.items.visibleConf.variable = !1) : (opts.items.visible || (opts = in_complementVisibleItems(opts, e)), opts[opts.d.width] || (!opts.items.visibleConf.variable && is_number(opts.items[opts.d.width]) && "*" == opts.items.filter ? (opts[opts.d.width] = opts.items.visible * opts.items[opts.d.width], opts.align = !1) : opts[opts.d.width] = "variable"), is_undefined(opts.align) && (opts.align = !!is_number(opts[opts.d.width]) && "center"), opts.items.visibleConf.variable && (opts.items.visible = gn_getVisibleItemsNext(d, opts, 0))), "*" == opts.items.filter || opts.items.visibleConf.variable || (opts.items.visibleConf.org = opts.items.visible, opts.items.visible = gn_getVisibleItemsNextFilter(d, opts, 0)), opts.items.visible = cf_getItemsAdjust(opts.items.visible, opts, opts.items.visibleConf.adjust, $tt0), opts.items.visibleConf.old = opts.items.visible, opts.responsive) opts.items.visibleConf.min || (opts.items.visibleConf.min = opts.items.visible), opts.items.visibleConf.max || (opts.items.visibleConf.max = opts.items.visible), opts = in_getResponsiveValues(opts, d, e); else switch (opts.padding = cf_getPadding(opts.padding), "top" == opts.align ? opts.align = "left" : "bottom" == opts.align && (opts.align = "right"), opts.align) {
                case"center":
                case"left":
                case"right":
